				...
				<form>
					...
					<div class="preguntasForm">
						<div class="input-group margin-bottom-sm">
							...
							<input type="text" class="form-control form-control-lg" id="nombre" placeholder="Nombre y Apellido">
						</div>
						<div class="input-group margin-bottom-sm">
						...
						<div class="input-group margin-bottom-sm">
							...
							<select class="form-control form-control-lg" id="economia">
						...
						<div class="input-group margin-bottom-sm">
							...
							<select class="form-control form-control-lg" id="experiencia">
								...
								<option value="1">Un año o menos</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="5">5</option>
								<option value="6">6 y mas</option>
							</select>
							<span class="input-group-addon"><i class="fa fa-sort-desc fa-fw"></i></span>
						</div>
						<div class="input-group margin-bottom-sm">
							<span class="input-group-addon"><i class="fa fa-users fa-fw"></i></span>
							<select class="form-control form-control-lg" id="trabajo">
						...
						<div class="input-group margin-bottom-sm">
							...
							<select class="form-control form-control-lg" id="instruccion">
						...
						<div class="input-group margin-bottom-sm">
							...
							<input type="text" class="form-control form-control-lg" id="linkedin" aria-describedby="linkedin" placeholder="Dirección de Linkedin">
						</div>
						<div class="input-group margin-bottom-sm">
							<span class="input-group-addon"><i class="fa fa-envelope-o fa-fw"></i></span>
							<input type="email" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Enter email">
						</div>
